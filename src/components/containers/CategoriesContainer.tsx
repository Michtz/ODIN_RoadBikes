...
const CategoriesContainer: FC = () => {
  const items: any[] = [
    ...
    },
    {
      ...
      alt: 'Odin Bike',
      title: 'Slide',
      text: 'Das Slide ist ein preisgünstiger Allrounder ab 3150 Franken. Etwas Aero, gepaart mit komfortabler Geometrie und 32 mm Reifenfreiheit, macht es zum perfekten Rennrad für lange Touren.',
