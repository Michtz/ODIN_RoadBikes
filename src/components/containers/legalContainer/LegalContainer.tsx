    ...
    <Container flow={'column'}>
      ...
      <Accordion title="§ 1 Geltungsbereich" defaultOpen={true}>
        <p>
          ...
          sämtliche Rechtsbeziehungen zwischen <strong>BIKESCHMIEDE GmbH</strong>, Gemeindehausplatz 13, 6048 Horw, Schweiz und seinen Kundinnen und Kunden betreffend:
        </p>
        <ul>
      ...
      <Accordion title="§ 2 Vertragsschluss">
        ...
        <ul>
          <li>bei Waren durch Annahme der Bestellung oder Übergabe der Ware,</li>
          <li>bei Werkstatt- oder Bikefitting-Leistungen durch Auftragsannahme.</li>
        </ul>
        <p>
      ...
      <Accordion title="§ 10 Datenschutz">
        <p>
          Personendaten werden unter Einhaltung der Bestimmungen des Schweizer Datenschutzgesetzes (DSG) bearbeitet. Einzelheiten ergeben sich aus der separaten Datenschutzerklärung der BIKESCHMIEDE GmbH.
        </p>
      </Accordion>
